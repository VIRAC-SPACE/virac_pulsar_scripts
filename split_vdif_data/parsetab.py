...
_lr_productions = [
  ...
  ('block_line -> REF DOLLAR word EQ value SEMICOLON','block_line',6,'p_block_line','vex.py',170),
  ('block_line -> word EQ value SEMICOLON','block_line',4,'p_block_line','vex.py',171),
  ('value -> word','value',1,'p_value','vex.py',181),
  ('value -> <empty>','value',0,'p_value','vex.py',182),
  ('value -> value COLON word','value',3,'p_value','vex.py',183),
  ('value -> value COLON','value',2,'p_value','vex.py',184),
  ('word -> IDENT','word',1,'p_word','vex.py',202),
  ('word -> word IDENT','word',2,'p_word','vex.py',203),
]
